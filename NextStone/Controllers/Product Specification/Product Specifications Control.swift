//
//  Product Specifications Control.swift
//  NextStone
//
//  Created by User on 06/09/18.
...
class Product_Specifications_Control: AbstractControl, WKUIDelegate, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        let urlRequest = URLRequest(url: URL(string: APIS.PRODUCT_SPECIFICATION)!)
